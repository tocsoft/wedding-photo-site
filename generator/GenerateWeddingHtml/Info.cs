	...
	public class Info
	{
        ...
        public string Title
        {
            get
            {
                try
                {
                    return (string)PropertyTag.getValue(_image.GetPropertyItem((int)PropertyTagId.ImageTitle));
                }
                catch { return null; }
            }
        }
        ...
        public string[] Artists
        {
            get
            {
                try
                {
                    return ((string)PropertyTag.getValue(_image.GetPropertyItem((int)PropertyTagId.Artist))).Split(';');
                }
                catch { return null; }
            }
        }
